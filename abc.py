...
def add_background():
    st.markdown(
        ...
        <style>
        .stApp {
            background: https://cdn.tatlerasia.com/asiatatler/i/ph/2020/04/14145432-valdemaras-d-7vpfyhb-j8y-unsplash_cover_1920x1217.jpg);
...
def add_background():
    st.markdown(
        ...
        <style>
        .stApp {
            background-image: url("https://cdn.wallpapersafari.com/43/90/Gw7arv.jpg");
